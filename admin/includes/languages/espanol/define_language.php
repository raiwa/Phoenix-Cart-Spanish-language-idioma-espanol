...
<p>Cada definición de idioma es asignada utilizando la función PHP <a href="http://www.php.net/define" target="_blank" rel="noreferrer">define()</a> de la siguiente manera:</p>

...
const TEXT_DATE_ACCOUNT_CREATED = 'Cuenta Creada: %s';
const TEXT_DATE_ACCOUNT_LAST_MODIFIED = 'Última Modificación: %s';
const TEXT_INFO_DATE_LAST_LOGON = 'Última Visita: %s';
const TEXT_INFO_NUMBER_OF_LOGONS = 'Número de visitas: %s';
const TEXT_INFO_COUNTRY = 'País: %s';
const TEXT_INFO_NUMBER_OF_REVIEWS = 'Número de Comentarios: %s';
...
const CUSTOMER_REVIEW_ANONYMIZED = 'Cliente verificado';

...
const TITLE_INSTALLED_VERSION = 'Versión Instalada: <strong>Phoenix v%s</strong>';
...
const VERSION_RUNNING_LATEST = 'Se está ejecutando la última versión de Phoenix.';
const VERSION_UPGRADES_AVAILABLE = <<<'EOT'
<strong>
¡Phoenix %s</strong> es la última versión disponible para Usted!<hr>

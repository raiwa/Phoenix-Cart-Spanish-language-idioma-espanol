...
const TEXT_NEW_PRODUCT = 'Añadiendo nuevo Producto <br><small class="text-muted">en %s</small>';
const TEXT_EXISTING_PRODUCT = 'Editando %s<br><small class="text-muted">en %s</small>';

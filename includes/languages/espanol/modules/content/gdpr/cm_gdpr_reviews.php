...
*/
  ...
  const MODULE_CONTENT_GDPR_REVIEWS_TITLE = 'Opiniones RGPD';
  const MODULE_CONTENT_GDPR_REVIEWS_DESCRIPTION = 'Este módulo muestra el número de opiniones escritas por el cliente.';

  const MODULE_CONTENT_GDPR_REVIEWS_PUBLIC_TITLE = 'Opiniones';
  const MODULE_CONTENT_GDPR_REVIEWS_NUM_REVIEWS = 'Ha escrito<br><span class="h1"><span class="num_reviews">%s</span></span><br>opinión(es)';

...
*/
  ...
  <span class="position-relative">
    <i title="Carrito de Compra: %1$s producto(s) en su carrito" class="fas fa-shopping-cart fa-fw fa-xl"></i>
...
SC;
  ...
  const MODULE_NAVBAR_SHOPPING_CART_NO_CONTENTS = '<i class="fas fa-shopping-cart fa-fw"></i> 0 productos';
  const MODULE_NAVBAR_SHOPPING_CART_HAS_CONTENTS = '<span class="cart-count">%s</span> producto(s), <span class="cart-value">%s</span>';
  const MODULE_NAVBAR_SHOPPING_CART_VIEW_CART = '<i class="fas fa-eye fa-fw"></i> Ver Carrito completo';
  const MODULE_NAVBAR_SHOPPING_CART_CHECKOUT = '<i class="fas fa-angle-right fa-fw"></i> Realizar Pedido';

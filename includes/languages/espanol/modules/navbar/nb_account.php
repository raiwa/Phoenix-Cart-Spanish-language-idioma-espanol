...
LI;
  ...
  <span class="d-inline d-sm-none">%s, está conectado</span>
LI;
  ...
  const MODULE_NAVBAR_ACCOUNT = 'Perfil';
  const MODULE_NAVBAR_ACCOUNT_HISTORY = 'Pedidos';
  const MODULE_NAVBAR_ACCOUNT_EDIT = 'Detalles';
  const MODULE_NAVBAR_ACCOUNT_ADDRESS_BOOK = 'Direcciones';
  const MODULE_NAVBAR_ACCOUNT_PASSWORD = 'Contraseña';

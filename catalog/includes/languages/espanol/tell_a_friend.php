...
define('TEXT_EMAIL_SUCCESSFUL_SENT', 'Tu correo electrónico sobre <b>%s</b> ha sido enviado con éxito a <b>%s</b>.');
...
define('ERROR_FROM_ADDRESS', 'Error: Su dirección de correo electrónico debe de ser válida.');
define('ERROR_ACTION_RECORDER', 'Error: Ya ha sido enviado un Correo electrónico. Por favor, inténtelo otra vez en %s minutos.');

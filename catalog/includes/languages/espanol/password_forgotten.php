...
define('TEXT_PASSWORD_RESET_INITIATED', 'Por favor, compruebe su correo electrónico para obtener instrucciones sobre cómo cambiar su contraseña. Las instrucciones contienen un enlace que sólo es válido durante 24 horas o hasta que su contraseña haya sido actualizada.');

define('TEXT_NO_EMAIL_ADDRESS_FOUND', 'Error: Este correo electrónico no figura en nuestros datos, inténtelo de nuevo.');
...
define('IMAGE_BUTTON_RESET_PASSWORD', 'Restablecer mi Contraseña');

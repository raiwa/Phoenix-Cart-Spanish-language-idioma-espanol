...
const MODULE_CUSTOMER_DATA_EMAIL_ADDRESS_TEXT_TITLE = 'Correo electrónico';
const MODULE_CUSTOMER_DATA_EMAIL_ADDRESS_TEXT_DESCRIPTION = 'Mostrar un campo de correo electrónico en el registro de cliente';

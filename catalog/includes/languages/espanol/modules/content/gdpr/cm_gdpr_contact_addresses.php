...
*/
  ...
  const MODULE_CONTENT_GDPR_CONTACT_ADDRESSES_TITLE = 'Detalles de la dirección RGPD';
  const MODULE_CONTENT_GDPR_CONTACT_ADDRESSES_DESCRIPTION = 'Mostrar las *otras* Direcciones de los clientes en la página RGPD.';

...
const TEXT_DISPLAY_NUMBER_OF_PRODUCTS = 'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> productos)';
...
const TEXT_DESCENDINGLY = 'Ordenar productos descendentemente por %s';
const TEXT_ASCENDINGLY = 'Ordenar productos  ascendentemente por %s';

...
define('TAB_TITLE_SUMMARY','<i class="fas fa-info-circle fa-fw mr-1"></i>Resumen');
define('TAB_TITLE_PRODUCTS','<i class="fas fa-box-open fa-fw mr-1"></i>Productos');
define('TAB_TITLE_STATUS_HISTORY','<i class="fas fa-history fa-fw mr-1"></i>Historial de Estado');

define('TABLE_HEADING_OID', 'Pedido');
...
define('TEXT_DATE_ORDER_CREATED', 'Creado el: %s');
define('TEXT_DATE_ORDER_LAST_MODIFIED', 'Última Modificación: %s');
define('TEXT_INFO_PAYMENT_METHOD', 'Método de Pago: %s');
...
define('ERROR_ORDER_DOES_NOT_EXIST', '<strong>Error:</strong> No existe pedido.');
define('SUCCESS_ORDER_UPDATED', '<strong>Éxito:</strong> Pedido actualizado correctamente.');
define('WARNING_ORDER_NOT_UPDATED', '<strong>Advertencia:</strong> Nada que cambiar. El pedido no ha sido actualizado.');
